...
<body>
    ...
    ?>
        ...
        <div class="container my-5">
            ...
            <a href=" A_diagnosis.php?do=add " class="btn btn-primary">Create Diagnosis</a>
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                ...
                <tbody>
                    <?php foreach ($patients as $patient) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="A_diagnosis.php?do=edit&id= <?= $patient['id']; ?>" class="btn btn-primary  ">Edit</a>
                                <a href="A_diagnosis.php?do=delete&id= <?= $patient['id']; ?>" class="btn btn-danger my-2">Delete</a>
    ...
    ?>
        <div class="container my-5">
            ...
            <form action="A_diagnosis.php?do=insert" method="post" class="col-8 shadow mx-auto p-5 " enctype="multipart/form-data">
    ...
    <?php
        ...
        if (isset($errors)) {
            ...
            header("Refresh:3;url=A_diagnosis.php?do=add");

            echo "</div>";
        } else {
            $columns = "patient, severity, general_diagnosis, detailed_diagnosis";
            $values = "'$patient', '$severity', '$general_diagnosis', '$detaild_diagnosis'";
            insert("ahmed_diagnosis", $columns, $values);
            header("location:A_diagnosis.php");
        }
    } elseif ($do == "delete") {
        $id = $_GET['id'];
        delete("ahmed_diagnosis", $id);
        header("location:A_diagnosis.php");
    } elseif ($do == 'edit') {
        $id = $_GET['id'];
        $inpatient = single("ahmed_diagnosis", $id);
    ?>
        <div class="container my-5">
            <form action="A_diagnosis.php?do=update" method="post" class="col-8 shadow mx-auto p-5 " enctype="multipart/form-data">
